      ...
      <transition name="fade" mode="out-in">
        <div v-if="step === 1" class="step-container input-step" key="step1">
          ...
          <div class="suggestions">
            <span>Try:</span>
            <button @click="topic = 'Digital Marketing Trends 2025'">Digital Marketing Trends</button>
              ...
              >
                <div class="thumb-preview">
                  ...
                  <div class="thumb-content-preview">
                    <div v-for="line in slide.content.split('\n').slice(0, 3)" :key="line" class="thumb-line"></div>
                  </div>
                </div>
            ...
            <div class="slide-workspace">
              <div class="slide-canvas">
                <div class="slide-content">
                  <input v-model="outline[currentSlideIndex].title" class="editor-title" placeholder="Slide Title" />
                ...
                <div class="slide-footer">
                  ...
                  <span class="slide-number-display">{{ currentSlideIndex + 1 }} / {{ outline.length }}</span>
                </div>
              </div>
              
              <div class="editor-controls">
                <div class="nav-controls">
                  <button class="nav-btn" @click="currentSlideIndex > 0 ? currentSlideIndex-- : null" :disabled="currentSlideIndex === 0">Previous</button>
                  <button class="nav-btn" @click="currentSlideIndex < outline.length - 1 ? currentSlideIndex++ : null" :disabled="currentSlideIndex === outline.length - 1">Next</button>
                </div>
...
const exportPPT = () => {
  ...
  pres.defineSlideMaster({
    ...
    objects: [
      ...
      { text: { text: "AI Generated Presentation", options: { x: 0.5, y: 0.2, w: 8, h: 0.4, color: "FFFFFF", fontSize: 14 } } }
    ]
  });
  ...
  outline.value.forEach((slide) => {
    ...
    const bulletItems = bullets.map(b => ({ text: b, options: { fontSize: 18, breakLine: true } }));
...
.thumb-line:nth-child(2) { width: 75%; }
.thumb-line:nth-child(3) { width: 60%; }
